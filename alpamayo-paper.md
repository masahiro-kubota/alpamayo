...
*   **3.1 VLMバックボーン: Cosmos-Reason**: 物理AI（Physical AI）向けに特別に事前学習されたVLM「Cosmos-Reason」を採用。物理的な常識や運転シナリオの理解に優れています。
*   **3.2 ドメイン固有の適応**:
...
*   **4.3 ハイブリッドラベリング手順**:
    ...
    *   **自動ラベリング**: GPT-5等のVLMを用い、ルールベースのメタアクション検出を補助として大規模データを生成。
